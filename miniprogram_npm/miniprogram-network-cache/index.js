...
__DEFINE__(1562552101848, function(require, module, exports) {

Object.defineProperty(exports, "__esModule", { value: true });
var cache_operator_1 = require("./cache-operator");
exports.CacheOperator = cache_operator_1.CacheOperator;
exports.defaultKeyBuilder = cache_operator_1.defaultKeyBuilder;
exports.isOkResult = cache_operator_1.isOkResult;
//# sourceMappingURL=index.js.map
}, function(modId) {var map = {"./cache-operator":1562552101849}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1562552101849, function(require, module, exports) {
...
var CacheOperator = /** @class */ (function () {
    ...
    CacheOperator.prototype.handle = function (options) {
        ...
        if (result) {
            ...
            var data = __assign({}, options, { success: function (res) {
                    ...
                    _this._getMapBeforeComplete(key).fail
                        .forEach(function (v) { v(res); });
        ...
        return {
            abort: function () {
                if (_this.callbackListMap[key]) {
                    if (options.success) {
                        arrayRemove(_this.callbackListMap[key].success, options.success);
                    }
                    var callbackList = [];
                    if (options.fail) {
                        arrayRemove(_this.callbackListMap[key].fail, options.fail);
                        callbackList.push(options.fail);
                    }
                    if (options.complete) {
                        arrayRemove(_this.callbackListMap[key].complete, options.complete);
                        callbackList.push(options.complete);
                    }
                    var res_1 = { errMsg: 'request:fail abort', cancel: true, source: CacheOperator.name };
                    callbackList.forEach(function (f) { f(res_1); });
                }
            },
            onHeadersReceived: doNothing,
            onProgressUpdate: doNothing
        };
    };
    /**
     * fixed #10
...
}, function(modId) { var map = {"./cache":1562552101850}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1562552101850, function(require, module, exports) {
...
return __REQUIRE__(1562552101848);
})()
//# sourceMappingURL=index.js.map